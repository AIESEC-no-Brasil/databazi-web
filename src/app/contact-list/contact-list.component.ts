...
export class ContactListComponent implements OnInit {
  ...
  selectContactList() {
    console.log('lista', this.allProgramsContacts);
    switch (this.actualPage) {
      case 'hospede-um-intercambista':
        console.log(1)
        this.contactList = this.allProgramsContacts.host;
        break;
      case 'voluntario-global':
      console.log(2)
        this.contactList = this.allProgramsContacts.gv;
        break;
      case 'talento-global':
      console.log(3)
        this.contactList = this.allProgramsContacts.gt;
        break;
      case 'empreendedor-global':
      console.log(3)
        this.contactList = this.allProgramsContacts.ge;
        break;
    }
  }

  sortContacts() {
    this.contactList = _.sortBy(this.contactList, (contact) => { return contact.city });
  }
