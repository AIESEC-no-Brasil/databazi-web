...
export class LandingPageGvComponent implements OnInit {
  ...
  countries: any = [
    {
      ...
      link: 'https://aiesec.org/search?home_mcs=1535&type=1&earliest_start_date=2019-06-16&sort=-duration_min',
      active: true
    },
    {
      name: 'Peru',
      ...
      link: 'https://aiesec.org/search?home_mcs=1553&earliest_start_date=2019-06-16&type=1&sort=-duration_min',
      active: false
    },
    {
      name: 'Colômbia',
      ...
      link: 'https://aiesec.org/search?home_mcs=1551&earliest_start_date=2019-06-16&type=1&sort=-duration_min',
      active: false
    },
    {
      name: 'México',
      ...
      link: 'https://aiesec.org/search?home_mcs=1589&earliest_start_date=2019-06-16&type=1&sort=-duration_min',
      active: false
    },
    {
      name: 'Costa Rica',
      ...
      link: 'https://aiesec.org/search?home_mcs=577&earliest_start_date=2019-06-16&type=1&sort=-duration_min',
      active: false
    },
    {
      name: 'Portugal',
      ...
      link: 'https://aiesec.org/search?home_mcs=1544&earliest_start_date=2019-06-16&type=1&sort=-duration_min',
      active: false
    },
    {
      name: 'Itália',
      ...
      link: 'https://aiesec.org/search?home_mcs=1542&earliest_start_date=2019-06-16&type=1&sort=-duration_min',
      active: false
    },
    {
      name: 'Romênia',
      ...
      link: 'https://aiesec.org/search?home_mcs=1560&earliest_start_date=2019-06-16&type=1&sort=-duration_min',
      active: false
    }
  ]
  ...
  goToInscreva() {
    this.amplitude.trackingClickInscrevaGv();
  }

  goToFlConosco() {
    this.amplitude.trackingClickFlConoscoGv();
  }

  goToRepre() {
    this.amplitude.trackingClickFlrepresentativesGv();
  }
}
