...
export const router: Routes = [
  { path: "", component: LandingPageComponent },
  {
    ...
    loadChildren:
      "./landing-page-gv/landing-page-gv.module#LandingPageGvModule",
  },
  {
    path: "professor-global",
    loadChildren:
      "./landing-page-gt/landing-page-gt.module#LandingPageGtModule",
  },
  {
    path: "talento-global",
    loadChildren:
      "./landing-page-ge/landing-page-ge.module#LandingPageGeModule",
  },
  {
    path: "intercambio",
  ...
  },
  {
    ...
    loadChildren:
      "./form-membership/form-membership.module#FormMembershipModule",
  },
  {
